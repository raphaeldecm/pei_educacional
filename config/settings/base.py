...
MIGRATION_MODULES = {"sites": "sistema_pei.contrib.sites.migrations"}

# AUTHENTICATION
# ------------------------------------------------------------------------------
# https://docs.djangoproject.com/en/dev/ref/settings/#authentication-backends
AUTHENTICATION_BACKENDS = [
    "sistema_pei.suap_backend.backends.SuapCredentialsBackend",
...
ACCOUNT_FORMS = {"signup": "sistema_pei.users.forms.UserSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "sistema-pei API",
    "DESCRIPTION": "Documentation of API endpoints of sistema-pei",
    "VERSION": "1.0.0",
