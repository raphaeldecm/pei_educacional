...
from sistema_pei.core.constants import SYNC_OLD_INTERVAL
...
class StudentFilter(django_filters.FilterSet):
    ...
    def get_student_by_sync_status(self, quaryset, name, value):
        ...
        filter_dates_values = {
            ...
            "REGULAR": [
                now() - timedelta(days=self.SYNC_REGULAR_INTERVAL),
                now() - timedelta(days=self.SYNC_RECENT_INTERVAL),
            ],
            "ANTIGA": [
                now() - timedelta(days=self.SYNC_OLD_INTERVAL),
                now() - timedelta(days=self.SYNC_REGULAR_INTERVAL),
            ],
        }
